...
public class Bag extends Product {
    ...
    // private string data field named type that specifies the number of bowling balls the bag can hold
    private String type;
    ...
    // Override the toString() method. Return an appended string of the superclass with an additional field for the bags type.
    @Override
